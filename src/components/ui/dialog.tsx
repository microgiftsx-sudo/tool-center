  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "dark:bg-zinc-900 bg-zinc-50 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-[calc(100%-1rem)] sm:w-full sm:max-w-lg translate-x-[-50%] translate-y-[-50%] gap-3 sm:gap-4 rounded-xl border p-3 sm:p-6 shadow-lg duration-200",
          className
        )}
        {...props}
      >
